" =============================================================================
" Neovim Configuration - vim-plug + coc.nvim + ALE + Lua Plugins
" =============================================================================
...
" Encoding (fileencoding still useful)
...
" File explorer (netrw - nvim-tree mapped in lua)
...
" Disable vim-go LSP (use coc.nvim instead)
